  ...
  return (
    ...
    <div className="w-full max-w-2xl max-h-[90vh] bg-white p-5 rounded-lg shadow-lg relative overflow-auto">
      ...
      <div className="flex flex-col gap-y-5 mt-4">
        ...
        <form className="flex flex-col md:flex-row md:justify-around md:items-center items-start justify-start gap-x-4 gap-y-4 bg-gray-200 p-4 rounded-lg">
          <div className="w-4/5">
            <label>Adjuntar constancia del depósito</label>
          ...
          <div>
            <button className="bg-gray-400 shadow-lg w-28 md:w-24 h-9 rounded-lg mt-4">Enviar</button>
          </div>
        </form>
      </div>
    </div>
