...
const ModificarMontoJPModal = ({ isOpen, onClose, solicitud }) => {
    ...
    try {
      const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/updateSolicitud`, {
        ...
        body: JSON.stringify({
          ...
          detallesPresupuesto,
          comentarioJPMonto: comentario,
        }),
      });

      if (res.ok) {
        console.log("Detalles guardados exitosamente:", detallesPresupuesto);
        onClose(); // Cerrar el modal después de guardar
      } else {
        console.error("Error al guardar los detalles del presupuesto");
      }
    } catch (error) {
...
export default ModificarMontoJPModal;
