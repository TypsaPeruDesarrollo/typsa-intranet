...
const RegistrosPagadosModal = ({ isOpen, onClose, solicitud }) => {
      ...
      <div className="w-full max-w-4xl max-h-[90vh] bg-white p-5 rounded-lg shadow-lg relative overflow-auto">
          ...
          <table className="min-w-full divide-y divide-gray-200 mt-4">
            <thead className="bg-gray-100">
              <tr>
                ...
                <th className="py-2 px-4 text-xs font-medium text-gray-500 text-center uppercase tracking-wider">Cantidad</th>
        ...
        <div className="flex flex-col gap-y-5 mt-4">
          <div className="p-2 w-60 ml-5 bg-[#976666] text-white rounded-sm">
            <p>Codigo de Viático: <span> 00{solicitud.SolicitudId}</span></p>
          </div>
          <ul className="list-none pl-4">
            ...
            <li className="m-2 mb-6">Colaborador: 
              <p className="text-gray-500">{solicitud.NombreEmpleado}</p>
            </li>
            <li className="m-2 mb-6">Jefe Aprobador: 
              <p className="text-gray-500">{solicitud.NombreJefeAprobador}</p>
            </li>
            <li className="m-2 mb-6">Jefe de Proyecto: 
              <p className="text-gray-500">{solicitud.NombreJefeProyecto}</p>
            </li>
            ...
            <li className="m-2 mb-6">Monto Aprobado por el Jefe: 
...
export default RegistrosPagadosModal;